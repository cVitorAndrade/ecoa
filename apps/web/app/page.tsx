  ...
  return (
    <main className="flex flex-col items-center justify-between min-h-screen p-24">
      <div className="z-10 items-center justify-between w-full max-w-5xl text-sm lg:flex">
        <h1 className="fixed top-0 left-0 flex justify-center w-full px-4 pt-8 pb-6 border backdrop-blur-2xl border-neutral-800 from-inherit lg:static lg:w-auto lg:rounded-xl lg:p-4 font-merriweather">
          examples/with-tailwind -&nbsp;
          <code className="font-mono font-bold">web</code>
        </h1>
        <p>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Saepe iure
          recusandae nihil odio illum, aut laudantium minus ducimus officia, in
          esse maiores dignissimos reprehenderit cumque. At in labore ut unde.
        </p>
